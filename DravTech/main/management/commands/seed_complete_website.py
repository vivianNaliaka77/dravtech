...
class Command(BaseCommand):
    help = 'Seed complete website content with uploaded images'

    def handle(self, *args, **options):
        self.stdout.write("🌱 Seeding complete DravTech website...")
        ...
        self.stdout.write(self.style.SUCCESS("✅ Complete website data seeded successfully!"))
    ...
    def create_about_page_content(self):
        ...
        # Sample Projects with uploaded images
        projects_data = [
            {
    ...
    def create_team_members(self):
        """Create team members with uploaded images"""
        ...
        team_data = [
            ...
            },
            {
                ...
                'bio': 'Backend specialist with expertise in API development and database optimization.',
                'photo': 'team/sam.jpeg',
                'display_order': 5,
                'is_active': True,
            },
            {
                ...
                'bio': 'Experienced project manager ensuring timely delivery of complex projects.',
        ...
        services_data = [
            {
                ...
                'tagline': 'Tailored web solutions for your business',
                'overview': 'We build custom web applications that solve specific business challenges and drive growth.',
            ...
            },
            {
                ...
                'tagline': 'Complete online store development',
                'overview': 'End-to-end e-commerce solutions with payment integration, inventory management, and analytics.',
                'category': web_dev_cat,
            ...
            },
            {
                ...
                'tagline': 'iOS and Android native apps',
                'overview': 'Native mobile applications that deliver superior performance and user experience.',
                'category': mobile_cat,
            ...
            },
            {
                ...
                'overview': 'Comprehensive UI/UX design services from research to final implementation.',
                'category': design_cat,
    ...
    def create_marketplace_products(self):
        ...
        # Clear existing marketplace products
        ...
        # Digital Products with uploaded images
        digital_products = [
            {
                ...
                'is_featured': True,
                'is_active': True,
                'image': 'downloads/web-toolkit.jpg',
            },
            {
                ...
                'is_featured': True,
                'is_active': True,
                'image': 'downloads/ui-design.jpg',
            },
        ]
        
        # Artwork with uploaded images
        artwork_products = [
            {
            ...
            },
            {
                ...
                'price': 3000,
                'is_active': True,
                'image': 'downloads/abstract-art.jpg',
            },
        ]
        
        all_products = digital_products + artwork_products
